...
function addProduto($conn, $nome_produto, $quantidade_min, $quantidade_atual) {
    //Código aqui
    $sql = "INSERT INTO cadastro (nome_produto, quantidade_min, quantidade_atual) VALUES (:nome_produto, :quantidade_min, :quantidade_atual)";
    $stmt = $conn->prepare($sql);
    $stmt->bindParam(':nome_prouto', $nome_produto);
...
function updateProduto($conn, $id, $nome_produto, $quantidade_min, $quantidade_atual) {
    //Código aqui
    $sql = "UPDATE cadastro SET nome_produto = :nome_produto, quantidade_min = :quantidade_min, quantidade_atual = :quantidade_atual WHERE id = :id";
    $stmt = $conn->prepare($sql);
